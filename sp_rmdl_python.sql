-- Operacion para habilitar Scripts de R y Pyhton en SqlServer
EXEC sp_configure
...
INSERT INTO rental_py_models (model_name, model) VALUES('modelo_01', @model);

-- Procedimiento Para relizar predicciones
...
-- Ejecutar Modelo de Predicciones
--Insert the results of the predictions for test set into a table
INSERT INTO py_rental_predictions
EXEC py_predict_rentalcount 'modelo_01';

-- Select contents of the table
SELECT * FROM py_rental_predictions;

SELECT * FROM py_rental_predictions where RentalCount_Predicted <> RentalCount_Actual;